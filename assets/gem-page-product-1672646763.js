    ...
    (function( jQuery ){
  var $module = jQuery('#m-1672646904731').children('.module');
  $module.gfV3Product();
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1672650495490').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1672650503979').children('.module');
  ...
  switch(style) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673246998532').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1672650451367').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1672650451367";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1672650451367") {
      window.getTab1672650451367 = function() {
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1672744712126').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1672771131022').children('.module');
  var style = $module.attr('data-style');
  ...
  $module.gfV3ProductQuantity({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1672771126324').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1672658578614').children('.module');   
    var navspeed = $module.data('navspeed'),
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673247060874').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1672658276702').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1672676441231').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1672812422481').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1672816591551').children('.module');

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'production') { 
    $module.children('form').on('submit', function() {
      try {
        localStorage.setItem('gemId', '#m-1672816591551');
      } catch(err) {}
    });
